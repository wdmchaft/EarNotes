...
@implementation GuitarTypeViewController

enum Sections {
	kGuitarTypesSection = 0,
	NUM_SECTIONS
};
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.section == kGuitarTypesSection) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.section == kGuitarTypesSection) {
		if ([[SharedAppData sharedInstance] numOfUsers] > 0) {
			[[[SharedAppData sharedInstance] currentUser] setGuitarType:indexPath.row];
		}
	}
