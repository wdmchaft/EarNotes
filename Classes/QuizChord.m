...
+(NSMutableArray *)loadDefaultChords {
	NSString *path = [[NSBundle mainBundle] pathForResource:@"defaultChords" ofType:@"plist"];
	...
	while ((key = [enumetaror nextObject])) {
		...
		obj = [[QuizChord alloc] initWithObjectId:[tmp objectForKey:@"id"] 
